...
_helloxv6:     file format elf32-i386
 ...
 34c:	89 d1                	mov    %edx,%ecx
{
 ...
 379:	0f b6 92 88 07 00 00 	movzbl 0x788(%edx),%edx
 ...
 3f9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 469:	ff 24 85 30 07 00 00 	jmp    *0x730(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 577:	90                   	nop
          s = "(null)";
 578:	ba 29 07 00 00       	mov    $0x729,%edx
        while(*s != 0){
 ...
 591:	a1 30 0a 00 00       	mov    0xa30,%eax
{
 ...
 5d1:	5b                   	pop    %ebx
  freep = p;
 5d2:	89 15 30 0a 00 00    	mov    %edx,0xa30
}
 5d8:	5e                   	pop    %esi
 5d9:	5f                   	pop    %edi
 5da:	5d                   	pop    %ebp
 ...
 609:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 60c:	89 15 30 0a 00 00    	mov    %edx,0xa30
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 629:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 62c:	8b 3d 30 0a 00 00    	mov    0xa30,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 66f:	73 4f                	jae    6c0 <malloc+0xa0>
    ...
    if(p == freep)
 671:	8b 3d 30 0a 00 00    	mov    0xa30,%edi
 ...
 69a:	e8 f1 fe ff ff       	call   590 <free>
  return freep;
 69f:	8b 15 30 0a 00 00    	mov    0xa30,%edx
 ...
 6cc:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 6cf:	89 15 30 0a 00 00    	mov    %edx,0xa30
}
 ...
 6df:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 6e0:	c7 05 30 0a 00 00 34 	movl   $0xa34,0xa30
 6e7:	0a 00 00 
    base.s.size = 0;
 6ea:	bf 34 0a 00 00       	mov    $0xa34,%edi
    base.s.ptr = freep = prevp = &base;
 6ef:	c7 05 34 0a 00 00 34 	movl   $0xa34,0xa34
 6f6:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 6f9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 6fb:	c7 05 38 0a 00 00 00 	movl   $0x0,0xa38
 702:	00 00 00 
    if(p->s.size >= nunits){
