  ...
  14:	83 39 03             	cmpl   $0x3,(%ecx)
{
  ...
  2f:	51                   	push   %ecx
  30:	8d 5d 84             	lea    -0x7c(%ebp),%ebx
  33:	51                   	push   %ecx
  34:	6a 02                	push   $0x2
  36:	ff 77 04             	push   0x4(%edi)
  39:	e8 d5 03 00 00       	call   413 <open>
	if (fd < 0) {
  ...
  47:	50                   	push   %eax
  48:	ff 77 04             	push   0x4(%edi)
  4b:	68 99 08 00 00       	push   $0x899
  50:	6a 01                	push   $0x1
  52:	e8 e9 04 00 00       	call   540 <printf>
		exit();
  57:	e8 77 03 00 00       	call   3d3 <exit>
  5c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
		printf(1, "%s", buf);
  60:	83 ec 04             	sub    $0x4,%esp
		buf[99] = 0;
  63:	c6 45 e7 00          	movb   $0x0,-0x19(%ebp)
		printf(1, "%s", buf);
  67:	53                   	push   %ebx
  68:	68 b1 08 00 00       	push   $0x8b1
  6d:	6a 01                	push   $0x1
  6f:	e8 cc 04 00 00       	call   540 <printf>
  ...
  7c:	53                   	push   %ebx
  7d:	56                   	push   %esi
  7e:	e8 68 03 00 00       	call   3eb <read>
  83:	83 c4 10             	add    $0x10,%esp
  86:	85 c0                	test   %eax,%eax
  88:	7f d6                	jg     60 <main+0x60>
	printf(1, "\n");
  8a:	50                   	push   %eax
  8b:	50                   	push   %eax
  8c:	68 e4 08 00 00       	push   $0x8e4
  91:	6a 01                	push   $0x1
  93:	e8 a8 04 00 00       	call   540 <printf>
	close(fd);
  98:	89 34 24             	mov    %esi,(%esp)
  9b:	e8 5b 03 00 00       	call   3fb <close>
	fd = open(argv[1], O_RDWR);
  a0:	58                   	pop    %eax
  a1:	5a                   	pop    %edx
  a2:	6a 02                	push   $0x2
  a4:	ff 77 04             	push   0x4(%edi)
  a7:	e8 67 03 00 00       	call   413 <open>
	if (fd < 0) {
  ...
  b3:	78 92                	js     47 <main+0x47>
	}

	//파일 내용 변경
	if (lseek(fd, atoi(argv[2]), SEEK_SET) < 0) {
  b5:	83 ec 0c             	sub    $0xc,%esp
  b8:	ff 77 08             	push   0x8(%edi)
  bb:	e8 a0 02 00 00       	call   360 <atoi>
  c0:	83 c4 0c             	add    $0xc,%esp
  c3:	6a 00                	push   $0x0
  c5:	50                   	push   %eax
  c6:	56                   	push   %esi
  c7:	e8 a7 03 00 00       	call   473 <lseek>
  cc:	83 c4 10             	add    $0x10,%esp
  cf:	85 c0                	test   %eax,%eax
  d1:	78 74                	js     147 <main+0x147>
  ...
  d6:	ff 77 0c             	push   0xc(%edi)
  d9:	e8 32 01 00 00       	call   210 <strlen>
  de:	83 c4 0c             	add    $0xc,%esp
  e1:	50                   	push   %eax
  e2:	ff 77 0c             	push   0xc(%edi)
  e5:	56                   	push   %esi
  e6:	e8 08 03 00 00       	call   3f3 <write>
  eb:	83 c4 10             	add    $0x10,%esp
  ee:	85 c0                	test   %eax,%eax
  f0:	78 6a                	js     15c <main+0x15c>
  ...
  f5:	6a 00                	push   $0x0
  f7:	56                   	push   %esi
  f8:	e8 76 03 00 00       	call   473 <lseek>
  fd:	83 c4 10             	add    $0x10,%esp
 100:	85 c0                	test   %eax,%eax
 102:	79 17                	jns    11b <main+0x11b>
 104:	eb 41                	jmp    147 <main+0x147>
		exit();
	}
 ...
 106:	51                   	push   %ecx
 107:	53                   	push   %ebx
 108:	68 b1 08 00 00       	push   $0x8b1
 10d:	6a 01                	push   $0x1
		buf[99] = 0;
 10f:	c6 45 e7 00          	movb   $0x0,-0x19(%ebp)
		printf(1, "%s", buf);
 113:	e8 28 04 00 00       	call   540 <printf>
 ...
 11e:	53                   	push   %ebx
 11f:	56                   	push   %esi
 120:	e8 c6 02 00 00       	call   3eb <read>
 125:	83 c4 10             	add    $0x10,%esp
 128:	85 c0                	test   %eax,%eax
 12a:	7f da                	jg     106 <main+0x106>
	}
	printf(1, "\n");
 12c:	50                   	push   %eax
 12d:	50                   	push   %eax
 12e:	68 e4 08 00 00       	push   $0x8e4
 133:	6a 01                	push   $0x1
 135:	e8 06 04 00 00       	call   540 <printf>

	close(fd);
 13a:	89 34 24             	mov    %esi,(%esp)
 13d:	e8 b9 02 00 00       	call   3fb <close>
	exit();
 142:	e8 8c 02 00 00       	call   3d3 <exit>
		printf(1, "error: lseek %s failed!\n", argv[1]);
 147:	53                   	push   %ebx
 148:	ff 77 04             	push   0x4(%edi)
 14b:	68 b4 08 00 00       	push   $0x8b4
 150:	6a 01                	push   $0x1
 152:	e8 e9 03 00 00       	call   540 <printf>
		exit();
 157:	e8 77 02 00 00       	call   3d3 <exit>
		printf(1, "error: write %s failed!\n", argv[1]);
 15c:	50                   	push   %eax
 15d:	ff 77 04             	push   0x4(%edi)
 160:	68 cd 08 00 00       	push   $0x8cd
 165:	6a 01                	push   $0x1
 167:	e8 d4 03 00 00       	call   540 <printf>
		exit();
 16c:	e8 62 02 00 00       	call   3d3 <exit>
 ...
 549:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 6c7:	90                   	nop
          s = "(null)";
 6c8:	ba e6 08 00 00       	mov    $0x8e6,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 6e1:	a1 fc 0b 00 00       	mov    0xbfc,%eax
{
 ...
 721:	5b                   	pop    %ebx
  freep = p;
 722:	89 15 fc 0b 00 00    	mov    %edx,0xbfc
}
 728:	5e                   	pop    %esi
 729:	5f                   	pop    %edi
 72a:	5d                   	pop    %ebp
 ...
 759:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 75c:	89 15 fc 0b 00 00    	mov    %edx,0xbfc
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 779:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 77c:	8b 3d fc 0b 00 00    	mov    0xbfc,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7bf:	73 4f                	jae    810 <malloc+0xa0>
    ...
    if(p == freep)
 7c1:	8b 3d fc 0b 00 00    	mov    0xbfc,%edi
 ...
 7ea:	e8 f1 fe ff ff       	call   6e0 <free>
  return freep;
 7ef:	8b 15 fc 0b 00 00    	mov    0xbfc,%edx
 ...
 81c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 81f:	89 15 fc 0b 00 00    	mov    %edx,0xbfc
}
 ...
 82f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 830:	c7 05 fc 0b 00 00 00 	movl   $0xc00,0xbfc
 837:	0c 00 00 
    base.s.size = 0;
 83a:	bf 00 0c 00 00       	mov    $0xc00,%edi
    base.s.ptr = freep = prevp = &base;
 83f:	c7 05 00 0c 00 00 00 	movl   $0xc00,0xc00
 846:	0c 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 849:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 84b:	c7 05 04 0c 00 00 00 	movl   $0x0,0xc04
 852:	00 00 00 
    if(p->s.size >= nunits){
